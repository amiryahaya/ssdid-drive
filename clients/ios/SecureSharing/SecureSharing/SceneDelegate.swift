...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private func handleDeepLink(_ url: URL) {
        ...
        // securesharing://action/{token} carries an opaque token instead of raw file IDs.
        if url.scheme == "securesharing", url.host == "action",
           let token = url.pathComponents.last, token != "/" {
            ...
            case .importFile:
                ...
                appCoordinator?.handleDeepLink(URL(string: "securesharing://import")!)
            case .openApp:
