...
final class DeepLinkParser {
    ...
    static let appGroupIdentifier = "group.com.securesharing"
    ...
    static func parse(_ url: URL) -> DeepLinkAction? {
        ...
        if url.scheme == "securesharing" {
            // Custom scheme: securesharing://share/123
            host = url.host
            pathComponents = url.pathComponents.filter { $0 != "/" }
        } else if url.scheme == "https" {
            // Universal Link: https://app.securesharing.app/share/123
