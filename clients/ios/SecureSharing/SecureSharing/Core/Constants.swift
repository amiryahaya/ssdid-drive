...
enum Constants {
    ...
    enum API {
        #if DEBUG
        static let baseURL = "https://api-dev.securesharing.app"
        #else
        static let baseURL = "https://api.securesharing.app"
        #endif
        ...
        #else
        static let piiServiceURL = "https://pii.securesharing.app/api/v1"
        #endif
        ...
        /// ```
        ///
        /// Example for api.securesharing.app:
        /// ```
        /// echo | openssl s_client -connect api.securesharing.app:443 2>/dev/null | \
        ///   openssl x509 -pubkey -noout | \
        ///   openssl pkey -pubin -outform der | \
        ///   openssl dgst -sha256 -binary | base64
        /// ```
    ...
    enum Keychain {
        static let serviceName = "com.securesharing.ios"
    ...
    enum App {
        static let name = "SecureSharing"
        static let bundleId = "com.securesharing.ios"
