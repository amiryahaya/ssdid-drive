...
enum FPConstants {
    ...
    #if DEBUG
    static let baseURL = "https://api-dev.ssdid-drive.app/v1"
    #else
    static let baseURL = "https://api.ssdid-drive.app/v1"
    #endif

    static let sharedKeychainService = "my.ssdid.drive.ios"
    ...
    static let appGroupSuite = "group.my.ssdid.drive"
    ...
    enum Domain {
        static let identifier = "my.ssdid.drive.user-files"
        static let displayName = "SsdidDrive"
    }
}
