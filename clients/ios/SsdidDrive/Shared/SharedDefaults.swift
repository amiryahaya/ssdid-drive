...
/// Uses App Group UserDefaults (`group.my.ssdid.drive`).
///
...
///   entitlement for `group.my.ssdid.drive` for this class to function.
final class SharedDefaults {
    ...
    static let suiteName = "group.my.ssdid.drive"

    /// Distributed notification name posted after writes so the helper refreshes immediately.
    static let changeNotificationName = "my.ssdid.drive.sharedDefaultsChanged"
