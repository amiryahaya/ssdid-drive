...
object SentryConfig {
    ...
    fun initialize(
        ...
        if (!enableInDebug && my.ssdid.drive.BuildConfig.DEBUG) {
            return
        }
        ...
        SentryAndroid.init(context) { options ->
            ...
            // Release tracking
            options.release = "${my.ssdid.drive.BuildConfig.APPLICATION_ID}@${my.ssdid.drive.BuildConfig.VERSION_NAME}+${my.ssdid.drive.BuildConfig.VERSION_CODE}"
