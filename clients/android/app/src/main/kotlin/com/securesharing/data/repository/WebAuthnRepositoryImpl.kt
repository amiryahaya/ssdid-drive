...
import com.securesharing.data.remote.dto.CredentialDto
import com.securesharing.data.remote.dto.EncryptedPrivateKeysDto
import com.securesharing.data.remote.dto.KeyBundlePublicKeysDto
import com.securesharing.data.remote.dto.RenameCredentialRequest
import com.securesharing.data.remote.dto.WebAuthnLoginBeginRequest
import com.securesharing.data.remote.dto.WebAuthnLoginCompleteRequest
import com.securesharing.domain.model.User
import com.securesharing.domain.model.UserCredential
import com.securesharing.domain.repository.WebAuthnBeginResult
        ...
        return try {
            ...
            if (keyBundle.source == "credential" && prfOutput != null) {
                ...
                val wrappingKey = cryptoManager.hkdfDerive(
                    prfBytes,
                    "securesharing-webauthn-mk".toByteArray(),
