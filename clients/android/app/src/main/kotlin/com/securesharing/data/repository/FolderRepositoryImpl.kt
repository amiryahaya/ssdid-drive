...
import com.securesharing.data.remote.dto.CreateFolderRequest
import com.securesharing.data.remote.dto.FolderDto
import com.securesharing.data.remote.dto.UpdateFolderRequest
import com.securesharing.domain.model.Folder
import com.securesharing.domain.model.FolderMetadata
...
class FolderRepositoryImpl @Inject constructor(
    ...
    override suspend fun moveFolder(folderId: String, newParentId: String): Result<Folder> {
        return try {
            ...
            // Create move request
            val request = com.securesharing.data.remote.dto.MoveFolderRequest(
    ...
    private fun com.securesharing.data.remote.dto.PublicKeysDto.toPublicKeys(): com.securesharing.domain.model.PublicKeys {
        return com.securesharing.domain.model.PublicKeys(
