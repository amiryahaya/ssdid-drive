...
This document outlines a comprehensive unit test plan for the SecureSharing Android app's invitation system. The plan covers UI, data validation, and edge cases across all layers of the architecture.
...
```
android/app/src/test/java/com/securesharing/
├── domain/model/
│   └── InvitationTest.kt
├── data/
│   ├── remote/dto/
...
android/app/src/androidTest/java/com/securesharing/
├── presentation/auth/
...
### Unit Tests (JVM)
```bash
./gradlew testDebugUnitTest --tests "com.securesharing.domain.model.InvitationTest"
./gradlew testDebugUnitTest --tests "com.securesharing.data.repository.*InvitationTest"
./gradlew testDebugUnitTest --tests "com.securesharing.presentation.*InvitationTest"
```

### Instrumented Tests (Device/Emulator)
```bash
./gradlew connectedDebugAndroidTest --tests "com.securesharing.presentation.auth.InviteAcceptScreenTest"
./gradlew connectedDebugAndroidTest --tests "com.securesharing.integration.*"
```
