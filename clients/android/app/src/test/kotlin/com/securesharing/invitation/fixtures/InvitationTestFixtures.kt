package com.securesharing.invitation.fixtures

import com.securesharing.data.remote.dto.*
import com.securesharing.domain.model.*
...
object InvitationTestFixtures {
    ...
    object DeepLinks {
        // Custom scheme
        const val customSchemeInvite = "securesharing://invite/abc123"
        const val customSchemeInviteWithDashes = "securesharing://invite/abc-123-def"
        const val customSchemeInviteWithUnderscores = "securesharing://invite/abc_123"
        const val customSchemeShare = "securesharing://share/share123"
        const val customSchemeFile = "securesharing://file/file123"
        const val customSchemeFolder = "securesharing://folder/folder123"

        // HTTP scheme
        const val httpSchemeInvite = "https://app.securesharing.example/invite/abc123"
        const val httpSchemeInviteWithQuery = "https://app.securesharing.example/invite/abc123?ref=email"
        const val httpSchemeInviteWithPort = "https://app.securesharing.example:8443/invite/abc123"
        const val httpSchemeShare = "https://app.securesharing.example/share/share123"

        // Invalid
        const val unsupportedScheme = "ftp://securesharing.example/invite/abc123"
        const val missingToken = "securesharing://invite/"
        const val emptyPath = "securesharing://invite"
        const val unknownHost = "securesharing://unknown/abc123"
