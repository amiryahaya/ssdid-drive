...
**Authors**: SSDID Drive Team

## 1. Overview

This document defines the complete sharing permission model for SSDID Drive, including:
...
SSDID Drive defines four access levels, in ascending order of privileges:
...
```elixir
defmodule SSDID Drive.Sharing do
  @doc """
