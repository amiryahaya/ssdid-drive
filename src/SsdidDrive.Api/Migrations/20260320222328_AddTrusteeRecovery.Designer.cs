...
namespace SsdidDrive.Api.Migrations
{
    ...
    [Migration("20260320222328_AddTrusteeRecovery")]
    partial class AddTrusteeRecovery
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SsdidDrive.Api.Data.Entities.Device", b =>
                {
                    ...
                    b.Property<string>("PushPlayerId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("SsdidDrive.Api.Data.Entities.ExtensionService", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("extension_services", (string)null);
                });
            ...
            modelBuilder.Entity("SsdidDrive.Api.Data.Entities.Login", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SsdidDrive.Api.Data.Entities.RecoveryRequest", b =>
                {
                    ...
                    b.Property<Guid>("RecoverySetupId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SsdidDrive.Api.Data.Entities.RecoveryRequestApproval", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("TrusteeUserId")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.HasIndex("TrusteeUserId");

                    b.HasIndex("RecoveryRequestId", "TrusteeUserId")
                        .IsUnique();

                    b.ToTable("recovery_request_approvals", (string)null);
                });
            ...
            modelBuilder.Entity("SsdidDrive.Api.Data.Entities.RecoveryTrustee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("RecoverySetupId", "TrusteeUserId")
                        .IsUnique();

                    b.ToTable("recovery_trustees", (string)null);
                });
            ...
            modelBuilder.Entity("SsdidDrive.Api.Data.Entities.Share", b =>
                {
                    ...
                    b.HasIndex("SharedWithId", "ResourceId")
            ...
            modelBuilder.Entity("SsdidDrive.Api.Data.Entities.TenantRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SsdidDrive.Api.Data.Entities.Login", b =>
                {
                    b.HasOne("SsdidDrive.Api.Data.Entities.User", "Account")
                        .WithMany("Logins")
            ...
            modelBuilder.Entity("SsdidDrive.Api.Data.Entities.RecoveryRequest", b =>
                {
                    b.HasOne("SsdidDrive.Api.Data.Entities.RecoverySetup", "RecoverySetup")
                        .WithMany()
                        .HasForeignKey("RecoverySetupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SsdidDrive.Api.Data.Entities.RecoveryRequestApproval", b =>
                {
                    ...
                    b.HasOne("SsdidDrive.Api.Data.Entities.User", "TrusteeUser")
                        .WithMany()
                        .HasForeignKey("TrusteeUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RecoveryRequest");

                    b.Navigation("TrusteeUser");
                });
            ...
            modelBuilder.Entity("SsdidDrive.Api.Data.Entities.TenantRequest", b =>
                {
                    b.HasOne("SsdidDrive.Api.Data.Entities.User", "RequesterAccount")
                        .WithMany()
                        .HasForeignKey("RequesterAccountId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("SsdidDrive.Api.Data.Entities.User", "Reviewer")
                        .WithMany()
